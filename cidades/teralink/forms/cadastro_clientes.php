...
/**
 * PROCESSAMENTO DE CADASTRO - TERALINK
...
try {
    ...
    $config = [
        ...
        'mail' => [
            ...
            'from' => $_ENV['SMTP_USER'],
            'from_name' => 'Teralink - Sistema de Cadastro',
            'to' => $_ENV['MAIL_TO'] ?? 'admteralink@gmail.com'
        ],
        'city_name' => 'Teralink - Fortaleza',
        'redirect_url' => $_ENV['REDIRECT_URL'] ?? 'https://idealsolucoes.tech/net'
    ];
    ...
    // Log do erro
    error_log("Erro no cadastro Teralink: " . $e->getMessage());
