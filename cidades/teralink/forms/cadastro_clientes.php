...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->addAddress('admteralink@gmail.com'); 
            ...
            echo "<script>
                ...
                window.location.href = 'https://idealsolucoes.tech/net'; // Redirecionar para uma página de sucesso
            </script>";
            ...
            echo "<script>
                ...
                window.location.href = 'https://idealsolucoes.tech/net';
            </script>";
        }
    } else {
        // Exibir erro SQL
