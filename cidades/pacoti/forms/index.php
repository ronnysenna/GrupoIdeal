...
<head>
    ...
    <meta name="description" content="Cadastro de clientes Ideal NET - Internet fibra óptica em Pacoti">
    <title>Cadastro de Clientes | Ideal NET Pacoti</title>
    
    <?php
    // Definir base URL automaticamente
    $protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
    $host = $_SERVER['HTTP_HOST'];
    // Remove /cidades/pacoti/forms do caminho para ficar na raiz
    $path = str_replace('/cidades/pacoti/forms', '', dirname($_SERVER['SCRIPT_NAME']));
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="cidades/pacoti/forms/imagens/icone.png">
    ...
    <style>
        /* Cores customizadas para Pacoti */
        :root {
...
<body>
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Ideal NET - Pacoti/CE</p>
        </div>

        <!-- Body -->
        <div class="form-body">
            <form id="cadastroForm" method="POST" action="cidades/pacoti/forms/cadastro_clientes.php">
                <div class="form-grid">
                    <!-- Data de Cadastro -->
