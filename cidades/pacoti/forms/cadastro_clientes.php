...
/**
 * PROCESSAMENTO DE CADASTRO - IDEAL NET PACOTI
...
try {
    ...
    $config = [
        ...
        'mail' => [
            ...
            'from' => $_ENV['SMTP_USER'],
            'from_name' => 'Ideal NET Pacoti - Sistema de Cadastro',
            'to' => $_ENV['MAIL_TO'] ?? 'macicoidealnet@gmail.com'
        ],
        'city_name' => 'Ideal NET - Pacoti',
    ...
    // Log do erro
    error_log("Erro no cadastro Pacoti: " . $e->getMessage());
