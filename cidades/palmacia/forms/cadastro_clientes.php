...
/**
 * PROCESSAMENTO DE CADASTRO - IDEAL NET PALMÁCIA
...
try {
    ...
    $config = [
        ...
        'mail' => [
            ...
            'from' => $_ENV['SMTP_USER'],
            'from_name' => 'Ideal NET Palmácia - Sistema de Cadastro',
            'to' => $_ENV['MAIL_TO'] ?? 'macicoidealnet@gmail.com'
        ],
        'city_name' => 'Ideal NET - Palmácia',
    ...
    // Log do erro
    error_log("Erro no cadastro Palmácia: " . $e->getMessage());
