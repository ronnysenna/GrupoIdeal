...
<head>
    ...
    <meta name="description" content="Cadastro de clientes Ideal NET - Internet fibra óptica em Palmácia">
    <title>Cadastro de Clientes | Ideal NET Palmácia</title>
    
    <?php
    // Definir base URL automaticamente
    $protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
    $host = $_SERVER['HTTP_HOST'];
    // Remove /cidades/palmacia/forms do caminho para ficar na raiz
    $path = str_replace('/cidades/palmacia/forms', '', dirname($_SERVER['SCRIPT_NAME']));
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="cidades/palmacia/forms/imagens/icone.png">
    ...
    <style>
        /* Cores customizadas para Palmácia */
        :root {
...
<body>
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Ideal NET - Palmácia/CE</p>
        </div>

        <!-- Body -->
        <div class="form-body">
            <form id="cadastroForm" method="POST" action="cidades/palmacia/forms/cadastro_clientes.php">
                <div class="form-grid">
                    <!-- Data de Cadastro -->
